...
var NavBar = function NavBar(props) {
  ...
  var handleNav = function handleNav() {
    if (navClassName !== "") {
      ...
      console.log("window.innerWidth: ".concat(window.innerWidth)); // collapsed navbar
  ...
  return __jsx("nav", {
    className: "navbar fixed-top navbar-expand-md " + navbarColor,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 92
    },
...
//# sourceMappingURL=projects.js.1397ff9f1c9755f4fa88.hot-update.js.map